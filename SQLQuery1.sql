...
BEGIN 
	...
	CREATE TABLE tbl_species (
		...
		species_animalia INT NOT NULL CONSTRAINT fk_animali_id FOREIGN KEY REFERENCES tbl_animalia(animalia_id) ON UPDATE CASCADE ON DELETE CASCADE,
