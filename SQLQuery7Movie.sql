...
GO
	...
	CREATE TABLE tbl_directors (
		...
		director_fname VARCHAR(50) NOT NULL,INT NOT NULL CONSTRAINT fk_director_fnam_id FOREIGN KEY REFERENCES tbl_actors(actor_id) ON UPDATE CASCADE ON DELETE CASCADE,
		director_lname VARCHAR(50) NOT NULL,INT NOT NULL CONSTRAINT fk_director_lname_id FOREIGN KEY REFERENCES tbl_actors(actor_id) ON UPDATE CASCADE ON DELETE CASCADE,
		director_movie VARCHAR(50) NOT NULL,INT NOT NULL CONSTRAINT fk_director_movie_id FOREIGN KEY REFERENCES tbl_actors(actor_id) ON UPDATE CASCADE ON DELETE CASCADE,
	);
